...
<body>
    <div class="container">
        ...
        <form name="cliente" method="POST" action="">
            <fieldset id="a">
                <legend>Informe o Nome do Editora Desejado</legend>
                <p>Editora: <input name="txteditora" type="text" size="40" maxlength="40" placeholder="Título do Livro"></p>
